...
public class CanvasViewModel {
    ...
    public boolean isDrawingSelectionBox = false;
    ...
    public double getSelectionStartX() { return selectionStartX; }
    public double getSelectionStartY() { return selectionStartY; }
    public double getSelectionEndX() { return selectionEndX; }
    public double getSelectionEndY() { return selectionEndY; }
