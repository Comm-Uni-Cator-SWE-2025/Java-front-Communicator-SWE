...
// NetworkService network = new CanvasNetworkService();
// CanvasState hostCanvasState = new CanvasState(); // The single source of
// truth

// // 2. Create the Host
// ActionManager hostManager = new HostActionManager("HOST-USER",
// hostCanvasState, network);

// // 3. Create a Client
// ActionManager clientManager = new ClientActionManager("CLIENT-USER-1", new
// CanvasState(), network);
...
// */
// private void launchWindow(String title, ActionManager actionManager) throws
// Exception {
// FXMLLoader loader = new
// FXMLLoader(getClass().getResource("/fxml/canvas-view.fxml"));
