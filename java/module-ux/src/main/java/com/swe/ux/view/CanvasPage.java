...
public class CanvasPage extends JPanel {
    ...
    private void initFX() {
        try {
            ...
            // Load CSS
            URL cssUrl = ClassLoader.getSystemClassLoader().getResource("fxml/canvas-view.css");
            if (cssUrl == null) {
                cssUrl = CanvasPage.class.getClassLoader().getResource("fxml/canvas-view.css");
            }
            if (cssUrl == null) {
                cssUrl = Thread.currentThread().getContextClassLoader().getResource("fxml/canvas-view.css");
            }
            if (cssUrl != null) {
