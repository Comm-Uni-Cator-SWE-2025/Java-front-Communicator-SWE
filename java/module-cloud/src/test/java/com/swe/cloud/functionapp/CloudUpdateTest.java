/******************************************************************************
 * Filename    = CloudUpdateTest.java
 * Author      = Nikhil S Thomas
 * Product     = cloud-function-app
 * Project     = Comm-Uni-Cator
 * Description = Unit tests for CloudUpdate Function Endpoint.
 *****************************************************************************/
...
/**
 * Tests for the CloudUpdate Azure Function endpoint.
 */
class CloudUpdateTest extends CloudTestBase {
    ...
    /** Verifies successful CloudUpdate execution. */
    @Test
